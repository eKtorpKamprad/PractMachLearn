...
The data for this project comes from wearable fitness tracker devices such as Jawbone Up, Nike FuelBand or Fitbit, collected by the quantifield self movement - a group of enthusiasts who take measurements about themselves regularly to improve their health, to find patterns in their behavior, or because they are tech geeks.

In this project, the goal consists of using the data from accelerometers on the belt, forearm, arm, and dumbell of 6 participants, whome were asked to perform barbell lifts correctly and incorrectly in 5 different ways, thus finally predicting the manner in which they did the exercise.
